...
public class MsgTutorial : MonoBehaviour
{
    ...
    public string[] msg = { 
        ...
        "Puedes atacarlos lanzandoles hechizos con tu magia: botón izquierdo del ratón es un ataque rápido, y el botón derecho es un ataque fuerte",
        "¡Pero cuidado! No podrás atacar mientras estés sosteniendo a la burbuja. Vuelve a pulsar “B” para dejarla y ataca, pero no dejes que la ataquen a ella",
